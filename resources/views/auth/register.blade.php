            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="personal_id_number" class="col-md-4 col-form-label text-md-end">{{ __('personalIdNumber') }}</label>

                            <div class="col-md-6">
                                <input id="personal_id_number" type="text" class="form-control @error('personal_id_number') is-invalid @enderror" name="personal_id_number" value="{{ old('personal_id_number') }}"  autocomplete="personal_id_number" autofocus>
