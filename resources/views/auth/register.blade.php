            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="personalIdNumber" class="col-md-4 col-form-label text-md-end">{{ __('personalIdNumber') }}</label>

                            <div class="col-md-6">
                                <input id="personalIdNumber" type="text" class="form-control @error('personalIdNumber') is-invalid @enderror" name="personalIdNumber" value="{{ old('personalIdNumber') }}" required autocomplete="personalIdNumber" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="month" type="tel" class="form-control @error('month') is-invalid @enderror" name="month" value="{{ old('month') }}" required autocomplete="month">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="year" type="tel" class="form-control @error('year') is-invalid @enderror" name="year" value="{{ old('year') }}" required autocomplete="year">
